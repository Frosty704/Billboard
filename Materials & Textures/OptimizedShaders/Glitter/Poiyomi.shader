Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/bdd0dfcf2df3d354aa51c6725cccbe7b"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if (float(0))
				{
					glitterColor.rgb = hueShift(glitterColor.rgb, float(1) + _Time.x * float(5));
				}
