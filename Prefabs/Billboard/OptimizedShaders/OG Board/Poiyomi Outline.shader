Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/f3992e23d70f1f2408846d1c18c88587"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float lineWidth = (0.75 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = min(poiLight.directColor, (0.75 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (0.75 /*_LightingCap*/));
				}
