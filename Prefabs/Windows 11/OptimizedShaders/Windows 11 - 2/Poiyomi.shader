Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/b46fbd2b2ab1fbe449790cb82766e25c"
{
	Properties
	{
		...
		_DecalBlendAlpha_Windows112D2 ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha1_Windows112D2 ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha2_Windows112D2 ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha3_Windows112D2 ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float  _DecalBlendAlpha_Windows112D2;
			...
			float _DecalBlendAlpha1_Windows112D2;
			...
			float _DecalBlendAlpha2_Windows112D2;
			...
			float _DecalBlendAlpha3_Windows112D2;
			...
			struct PoiDecal
			{
				...
				float     m_DecalBlendAlpha_Windows112D2;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_Windows112D2 + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_Windows112D2 					 = _DecalBlendAlpha_Windows112D2;
				...
				Decal1.m_DecalBlendAlpha_Windows112D2 					 = _DecalBlendAlpha1_Windows112D2;
				...
				Decal2.m_DecalBlendAlpha_Windows112D2 					 = _DecalBlendAlpha2_Windows112D2;
				...
				Decal3.m_DecalBlendAlpha_Windows112D2 					 = _DecalBlendAlpha3_Windows112D2;
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					if ((24.0 /*_FlipbookFPS*/) != 0)
					{
						currentFrame = ((_Time.y / (1 / (24.0 /*_FlipbookFPS*/))) + (42.0 /*_FlipbookFrameOffset*/)) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				if ((1.0 /*_FlipbookHueShiftEnabled*/))
				{
					flipBookPixel.rgb = hueShift(flipBookPixel.rgb, (0.0 /*_FlipbookHueShift*/) + _Time.x * (3.0 /*_FlipbookHueShiftSpeed*/));
				}
				...
				float flipbookEmissionStrength = (0.25 /*_FlipbookEmissionStrength*/);
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
