Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/89d05c46205c5774785a4136edfc23d7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			struct PoiDecal
			{
				...
				float     m_DecalBlendAlpha_Windows112DRetroScanlineCRT;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_Windows112DRetroScanlineCRT + audioLinkDecalAlpha);
